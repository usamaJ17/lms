                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        placeholder="Enter course name" value="{{ $course->name }}" name="name">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="degree_id" id="exampleSelectBorder">
                                        ...
                                        @foreach ($degree as $d)
                                            <option value="{{ $d->id }}" @if($d->id == $course->degree_id) selected @endif>{{ $d->name }}</option>    
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="teacher_id" id="exampleSelectBorder">
                                        ...
                                        @foreach ($teachers as $d)
                                            <option value="{{ $d->id }}" @if($d->id == $course->teacher_id) selected @endif>{{ $d->name }}</option>    
                                        @endforeach
                                    </select>
                                </div>
                            </div>
